...
void loop()
{
  ...
  controllerData.rightStickX = (byte)(((float)unAIL_In - 1000)/1000 * 255);
  controllerData.rightStickY = (byte)(((float)unELE_In - 1000)/1000 * 255);
  controllerData.leftStickX = (byte)(((float)unRUD_In - 1000)/1000 * 255);
  controllerData.leftStickY = (byte)(((float)unTHR_In - 1000)/1000 * 255);
